...
/**
 * RemovedDataEvent class that is passed along the notification performed by the {@code EventSource} class. The class is
...
public class RemovedDataEvent extends UpdatedDataEvent {
     ...
     */
    public RemovedDataEvent(final EventSource source, final UpdateEvent... parent) {
     ...
     * @param parent optional parent of the event
     */
    public RemovedDataEvent(final EventSource source, final String msg, final UpdateEvent... parent) {
     ...
     * @param parent optional parent of the event
     */
    public RemovedDataEvent(final EventSource source, final String msg, final Object payload, final UpdateEvent... parent) {
